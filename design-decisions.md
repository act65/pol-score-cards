...
- Why use clarity instead of evasion?
    - I wanted all the attributes to have the property that higher value means 'better'. We don't want politicians with high evasion... 
- Why use divination instead of 'ability to predict the future'?
    - Divination sounds more DnD-like.
